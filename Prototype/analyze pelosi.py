...
with open("PelosiTimeSeries.js", "+w") as outfile:
    outfile.write("var Pelosi_ScoreByTime = {\n")
    ctr = 0
    print("Pelosi sentiment score by time:")
    for inFileName in glob.glob('twitter_data/Pelosi_*', recursive=True):
...
outFile = open("PelosiStates.js", "+w")
outFile.write("var Pelosi_ScoreByState = {\n")

print("Pelosi sentiment score by state:")
...
while True:
    ...
    SortByState(all_Trump_tweets, 'Pelosi', line1Cut, line2Cut, outFile)
